    ...
    <Fragment>
      <div className="ml-4 relative flex-shrink-0">
        {auth && (
          ...
          >
            <button
              className="bg-yellow-600 dark:bg-green-400 flex text-sm rounded-full text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-yellow-400 focus:ring-white"
              id="user-menu"
              aria-haspopup="true"
            >
            ...
            <span className="dark:text-white text-gray-800 font-medium ml-2">
              {auth?.name}
            </span>
          </div>
        )}
        ...
        <div className="py-4 px-5 bg-white">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className="outline-none h-12 px-2 focus:outline-none border border-gray-300"
            />
          </div>
          ...
          <div className="flex mb-3 items-center">
            <button
              ...
              type="button"
              className={`${
                rememberme ? "bg-green-700" : "bg-gray-200"
          ...
          <div className="flex flex-col">
            <button
              ...
              className="bg-green-700 rounded-md text-white py-3"
            >
              Sign in
            </button>
          </div>
      ...
      <Modal show={showRegister} setShow={setShowRegister}>
        <Spin spinning={registering}>
          <form
            onSubmit={handleSubmit(onRegisterClicked)}
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                ref={register({ required: true })}
                type="email"
                placeholder="eg. johdoe@mail.com"
                className="outline-none h-12 px-2 focus:outline-none border border-gray-300"
              />
            </div>
            <div className="flex flex-col">
