      ...
      >
        ...
        <div className="overflow-hidden" style={{ marginTop: 44 }}>
          ...
          <div className="flex flex-col items-stretch pointer-events-auto transform translate-y-0">
            <div className="flex justify-center pt-0 px-4 pb-4 w-full">
                ...
                <div className="w-full px-2 lg:px-6">
                  ...
                  <div className="relative text-gray-200 focus-within:text-gray-400">
                    ...
                    <input
                      id="search"
                      name="search"
                      className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md leading-5 bg-white bg-opacity-25 text-gray-400 placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-0 focus:placeholder-gray-400 focus:text-gray-900 sm:text-sm"
                      placeholder="Search"
                      type="text"
                    />
                  </div>
