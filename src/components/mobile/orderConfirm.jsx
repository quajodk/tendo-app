    ...
    <>
      <div className="w-screen flex-1 overflow-y-scroll bg-tendo-bg z-20">
        ...
        <div className="mx-4 my-2 p-3 bg-blue-600 bg-opacity-10 rounded-sm border-1 text-blue-400 flex flex-col">
          ...
          <p>
            We charge a 10% processing fee on reseller profits only. This is to
            enable us cover the transaction costs involved in paying suppliers,
            logistics companies and resellers.{" "}
          </p>
        </div>
